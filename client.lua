			...
			if count > 0 then
				...
				if lockStatus < 2 then
					...
					exports.dopeNotify:SendNotification({					
						text = '<b><i class="fas fa-bell"></i> POWIADOMIENIE</span></b></br><span style="color: #a9a29f;">Pojazd zosta³ zamkniêty!',
						type = "success",
						timeout = 3000,
						layout = "topRight"
					})					
				...
				if vehicleKeys[plate] == nil or vehicleKeys[plate] == false then
					...
					if GetRandomIntInRange(1, 100) < 60 then
						...
						exports.dopeNotify:SendNotification({					
							text = '<b><i class="fas fa-bell"></i> POWIADOMIENIE</span></b></br><span style="color: #a9a29f;">Znalaz³eœ Klucze w stacyjce!',
							type = "success",
							timeout = 3000,
							layout = "topRight"
						})						
						...
						exports.dopeNotify:SendNotification({					
							text = '<b><i class="fas fa-bell"></i> POWIADOMIENIE</span></b></br><span style="color: #a9a29f;">Niestety nie znalaz³eœ kluczy!',
							type = "error",
							timeout = 3000,
							layout = "topRight"
						})									
